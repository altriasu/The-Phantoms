        ...
        <div class="login-wrapper">
            ...
            <div class="login-form">
                <div class="username form-item">
                    <span>用户名</span>
                    <input v-model="username" type="text" class="input-item">
                </div>
                <div class="password form-item">
                    <span>密码</span>
                    <input v-model="password" type="password" class="input-item">
                </div>
                <div class="password form-item">
                    <span>确认密码</span>
                    <input v-model="passwordconfirm" type="password" class="input-item">
                </div>
            ...
            <div class="other-login-wrapper">
                <div class="other-login-item">
                    <img src="../assets/images/register/QQ.png" alt="">
                </div>
                <div class="other-login-item">
                    <img src="../assets/images/register/WeChat.png" alt="">
                </div>
            </div> -->
        </div>
    </div>
...
@media (max-width: 768px) {
  .box .content {
    width: 100vw;
    height: 100vh;
    background: url("../assets/images/register/login_bg_phone.png") no-repeat;
